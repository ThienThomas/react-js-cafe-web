  ...
  return isLoggedIn ? (
    <>
      {!productList || productList?.length === 0 ? (
        <div className=" h-1/2">
          <img src={require('../../assets/images/empty-cart.webp')} className="mx-auto" />
          ...
          <div className=" w-full">
            <div className="flex gap-8">
              <div className="overflow-x-auto  shadow-md sm:rounded-lg w-9/12">
                ...
                <button
                  onClick={() => {
                    clearCart(), setDiscount(null);
                  }}
                  className="mt-10 ml-10  text-white uppercase p-4 bg-clrOrange/90 focus:bg-clrOrange focus:ring-1 focus:ring-clrOrange hover:bg-clrOrange  rounded-lg">
                  Xóa giỏ Hàng
                </button>
              </div>
